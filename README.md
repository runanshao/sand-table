...
7. **谋主沙盘：资源和人都有属性**（v3）。纸上谈兵和真做事的差距，在于真实世界的资源和人不会丝滑执行你的意图，甚至反噬。v2 场景带**资源盘**（天时/地利/兵粮/利益网/掣肘/人和——可用之人逐人带能力、私利、掣肘、反噬信号）：你先盘点、交完整方案，AI 谋主再出**六查对账单**（含对手视角反推、盟友背叛条件）——**盘点先行**，AI 先说就成了判断外包。揭示时多一条**执行摩擦**对账线：史实里那些人实际怎么打折、走样、倒戈。同一战役可换**席位**：官渡有曹操席（劣势赌用人）和袁绍席（满手好牌每张有毒）。
...
```
你：开沙盘 官渡 袁绍席
AI：[信息边界卡] + [资源盘：天时/地利/兵粮/利益网/掣肘/人和（逐人属性）]
你：盘点 + 完整方案（用谁、靠什么、防谁反噬、对手会怎么反制、谁可能背叛）
AI：[谋主六查对账单：你漏了什么——每条标注引自资源盘哪一项] → 你修订或坚持
    → [评分落盘] → [揭示 + 执行摩擦：史实里人和资源实际怎么走样] → 三线对账
```
跑完一局：
...
史鉴推演/
  ...
  library/
    ...
    caocao/guandu.blind.md   场景·盲区：官渡之战·曹操席【v2 资源盘】（情境官只读这个）
    caocao/guandu.sealed.md  场景·封存：官渡史实/出处/致死/对照体/执行摩擦（historian 子 agent 读）
    yuanshao/guandu-yuanshao.blind.md   场景·盲区：官渡之战·袁绍席【v2 资源盘】（同一战役换边打）
    yuanshao/guandu-yuanshao.sealed.md  场景·封存：袁绍席史实/出处/致死/对照体/执行摩擦
    sanguo/yiling.blind.md   场景·盲区：夷陵之战·刘备席【v2 资源盘】（情境官只读这个）
    sanguo/yiling.sealed.md  场景·封存：夷陵史实/出处/致死/对照体/执行摩擦（historian 子 agent 读）
...
**v0.x · 实验性**。当前 5 个场景（官渡·曹操席、官渡·袁绍席、夷陵·刘备席、于谦、古巴导弹危机；前三个为 v2 谋主沙盘）+ [选题菜单](library/CATALOG.md)（覆盖商/周/春秋战国/秦汉/三国/隋唐/宋/明/清 + 国外，二十余候选，按需建），单人自用为主。
